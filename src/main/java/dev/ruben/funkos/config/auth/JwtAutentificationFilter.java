...
import dev.ruben.funkos.config.auth.services.users.AuthUsersService;
...
public class JwtAutentificationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JwtAutentificationFilter(JwtService jwtService, AuthUsersService authUsersService) {
